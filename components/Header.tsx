...
const Header: React.FC<HeaderProps> = ({ activePage, onNavigate }) => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-[#1E1E1E]/95 backdrop-blur-md border-b border-[#333333] pt-safe">
          ...
          <div className="flex items-center">
             ...
             <div className="md:hidden">
                <button
                    ...
                    className="inline-flex items-center justify-center p-2 rounded-md text-[#BDBDBD] hover:text-[#FFFFFF] hover:bg-[#333333] focus:outline-none focus:ring-2 focus:ring-inset focus:ring-[#FFC107]"
      ...
      {/* Mobile Menu Panel - Bottom Sheet Style */}
      {isMenuOpen && (
        <div className="md:hidden fixed inset-0 z-50" id="mobile-menu">
          {/* Backdrop */}
          <div 
          ...
          />
          {/* Bottom Sheet */}
          <div className="absolute bottom-0 left-0 right-0 bg-[#1E1E1E] rounded-t-[20px] shadow-lg pb-safe">
